...
void info() {
  ...
  fprintf(stderr,"\t\t-npop\t\tNumber of populations. This MUST be set before -nind [1]\n");
  ...
  fprintf(stderr,"\t\t-seed\t\tRandom number seed [0]\n");
  fprintf(stderr,"\t\t-base_freq\tBackground allele frequencies for A,C,G,T [0.25 0.25 0.25 0.25]\n");
  fprintf(stderr,"\t\t-expansion\tVery naive method to simulate population expansion, boolean [0]\n");
}
